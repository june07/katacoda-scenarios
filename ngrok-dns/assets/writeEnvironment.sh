...
echo export REDIRECT_SERVICE=$(ls .REDIRECT_SERVICE_ID* | sed s@___@/@g | awk 'BEGIN {FS="PREDIRECT_SERVICE_APIKEY"}{print $2}' | awk 'BEGIN {FS="REDIRECT_SERVICE"}{print $2}') >> .bashrc
